    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                    <h1 class="mb-1 font-medium">Weather in Melkbosstrand</h1>
                    <div id="weather-widget" class="mb-4 lg:mb-6">
                        <div id="weather-loading" class="flex items-center gap-2 text-[#706f6c] dark:text-[#A1A09A]">
                            <div class="animate-spin w-4 h-4 border-2 border-current border-t-transparent rounded-full"></div>
                            <span>Loading weather data...</span>
                        </div>
                        <div id="weather-content" class="hidden">
                            <div class="bg-gradient-to-r from-blue-50 to-sky-50 dark:from-blue-950/20 dark:to-sky-950/20 rounded-lg p-4 mb-4 border border-blue-100 dark:border-blue-800/30">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-3">
                                        <img id="weather-icon" src="" alt="Weather icon" class="w-12 h-12">
                                        <div>
                                            <div class="text-2xl font-semibold text-blue-900 dark:text-blue-100" id="weather-temp"></div>
                                            <div class="text-sm text-blue-700 dark:text-blue-300" id="weather-description"></div>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-sm text-blue-600 dark:text-blue-400" id="weather-location"></div>
                                        <div class="text-xs text-blue-500 dark:text-blue-500" id="weather-time"></div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-3 gap-4 text-sm">
                                    <div class="text-center">
                                        <div class="text-blue-600 dark:text-blue-400 font-medium">Feels like</div>
                                        <div class="text-blue-900 dark:text-blue-100" id="weather-feels-like"></div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-blue-600 dark:text-blue-400 font-medium">Humidity</div>
                                        <div class="text-blue-900 dark:text-blue-100" id="weather-humidity"></div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-blue-600 dark:text-blue-400 font-medium">Wind</div>
                                        <div class="text-blue-900 dark:text-blue-100" id="weather-wind"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="weather-error" class="hidden">
                            <div class="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 rounded-lg p-4 text-red-700 dark:text-red-300">
                ...
                <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                    ...
                    <img src="{{ asset('luca-logo.png') }}" alt="Image" class="w-full h-full object-cover">
        ...
        <script>
            ...
            async function fetchWeatherData() {
                try {
                    const response = await fetch('/api/weather/current?city=Melkbosstrand');
            ...
            function displayWeatherData(data) {
                ...
                document.getElementById('weather-feels-like').textContent = `${data.feels_like}°C`;
                ...
                document.getElementById('weather-time').textContent = `Updated at ${timeString}`;
            }
